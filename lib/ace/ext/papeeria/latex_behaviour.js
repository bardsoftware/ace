...
(function() {
  ...
  define(function(require, exports, module) {
    var AUTO_INSERT, Behaviour, COMMENT_TYPE, CORRESPONDING_CLOSING, DO_NOTHING, EQUATION_TYPE, ESCAPE_TYPE, LatexBehaviour, MATH_TYPE, RPAREN_TYPE, SKIP, SKIP_TWO, dollarsDeletionAction, dollarsInsertionAction, getBracketInsertionAction, getBracketsDeletionAction, getWrapped, isCommentToken, isEscapedInsertion, isInEquation;
    ...
    isEscapedInsertion = function(token, column) {
      return (token != null) && token.type.indexOf(ESCAPE_TYPE) > -1 && column - token.start === 1;
    };
