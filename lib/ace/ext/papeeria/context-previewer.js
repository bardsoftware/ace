...
(function() {
  define(function(require, exports, module) {
    exports.setupPreviewer = function(editor, popoverHandler) {
      var curEnd, curStart, currentDelayedUpdateId, delayedUpdatePopover, getCurrentFormula, getEquationRange, getPopoverPosition, getTopmostRowNumber, getWholeEquation, handleCurrentContext, initKaTeX, initPopover, jqEditorContainer, jqFormula, katex, prevContext, ref, updatePopover;
      katex = null;
      ...
      getPopoverPosition = function(row) {
        var gutter, jqSecondRow, left, pxRowHeight, relativeRow, secondRowPosition, secondRowSelector, top;
