...
(function() {
  define(function(require, exports, module) {
    exports.setupPreviewer = function(editor, popoverHandler) {
      var curEnd, curStart, currentDelayedUpdateId, delayedUpdateContext, getCurrentFormula, getEquationRange, getPopoverPosition, getTopmostRowNumber, getWholeEquation, handleCurrentContext, initKaTeX, initPopover, jqEditorContainer, jqFormula, katex, prevContext, ref, updatePopover;
      katex = null;
      ...
      delayedUpdateContext = function() {
        if (delayedUpdateContext != null) {
          clearTimeout(delayedUpdateContext);
        }
        return delayedUpdateContext = setTimeout((function() {
          updatePopover;
          return delayedUpdateContext = null;
        }), 1000);
      };
