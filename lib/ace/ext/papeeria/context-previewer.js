...
(function() {
  define(function(require, exports, module) {
    exports.setupPreviewer = function(editor, popoverHandler) {
      var curEnd, curStart, editorContainer, getEquationRange, getPopoverPosition, getTopmostRowNumber, getWholeEquation, handleCurrentContext, initKaTeX, initPopover, katex, prevContext, ref, updatePopover;
      katex = null;
      ...
      initPopover = function() {
        ...
        try {
          return content = katex.renderToString(getWholeEquation(curStart, curEnd), {
            displayMode: true
          });
        } catch (error) {
          e = error;
