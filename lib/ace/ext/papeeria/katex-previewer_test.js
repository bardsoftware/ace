...
define(function(require, exports, module) {
    ...
    module.exports = {
        "test: EquationRangeHandler, inside \\begin{equation} \\end{equation}": function() {
            ...
            var equationOuterRange = equationRanges[0];
            var equationInnerRange = equationRanges[1];
        ...
        "test: EquationRangeHandler, two in a row": function() {
            ...
            var equationOuterRange1 = equationRanges1[0];
            var equationInnerRange1 = equationRanges1[1];
