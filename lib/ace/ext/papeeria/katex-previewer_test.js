...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "test: EquationRangeHandler, inside \\[ \\]": function() {
            ...
            assert.range(equationRange, 0, 3, 0, 19);
        },
        ...
        "test: EquationRangeHandler, inside $ $": function() {
            ...
            assert.range(equationRange, 0, 2, 0, 18);
        },
        ...
        "test: EquationRangeHandler, inside \\[": function() {
            ...
            var equationRange = (new EquationRangeHandler(editor)).getEquationRange(0, 1);

            assert.range(equationRange, 0, 3, 0, 19);
        },

        "test: EquationRangeHandler, inside starting $": function() {
            var session = new EditSession(["$ \\text{hi there!} $"]);
            //                              01 2345678901234567890
            //                              0          10        20
            var editor = new Editor(new MockRenderer(), session);
            ...
            var equationRange = (new EquationRangeHandler(editor)).getEquationRange(0, 0);
        ...
        "test: EquationRangeHandler, inside \\]": function() {
            ...
            var equationRange = (new EquationRangeHandler(editor)).getEquationRange(0, 21);

            assert.range(equationRange, 0, 3, 0, 19);
        },

        "test: EquationRangeHandler, inside ending $": function() {
            var session = new EditSession(["$ \\text{hi there!} $"]);
            //                              01 2345678901234567890
            //                              0          10        20
            var editor = new Editor(new MockRenderer(), session);
        ...
        "test: EquationRangeHandler, inside ending $ followed by another equation": function() {
            var session = new EditSession(["$ \\text{hi there!} $  $$ \\text{oh hello!} $$"]);
            //                              01 2345678901234567890123 45678901234567890123
            //                              0          10        20         30        40
            var editor = new Editor(new MockRenderer(), session);
            session.setMode("./mode/papeeria_latex");
