...
(function() {
  ...
  define(function(require, exports, module) {
    var EQUATION_END_ENVIRONMENTS, EQUATION_ENVIRONMENTS, GREEK_LETTERS, MATH_SNIPPETS, SUMS_AND_INTEGRALS, capitalizeGreekLetter, compare, env, i;
    EQUATION_ENVIRONMENTS = ["equation", "equation*"];
    EQUATION_END_ENVIRONMENTS = (function() {
      var j, len, results;
      results = [];
      for (j = 0, len = EQUATION_ENVIRONMENTS.length; j < len; j++) {
        env = EQUATION_ENVIRONMENTS[j];
        results.push({
          caption: "\\end{" + env + "}",
          value: "\\end{" + env + "}",
          score: 0,
