...
(function() {
  define(function(require, exports, module) {
    var Range, findSurroundingBrackets, highlightingBrackets;
    Range = require("ace/range").Range;
    highlightingBrackets = function(editor) {
    ...
    findSurroundingBrackets = function(editor) {
      var allBrackets, key, leftBracket, leftCandidate, leftNearest, position, result, rightBracket, rightCandidate, rightNearest, session;
