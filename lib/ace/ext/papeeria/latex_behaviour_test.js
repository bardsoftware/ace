...
define(function(require, exports, module) {
    ...
    var testInsertion = function(range, string, expected) {
        editor.selection.setSelectionRange(range);
        editor.commands.exec("insertstring", editor, string);
        assert.equal(editSession.getLine(range.start.row), expected);
    }
    ...
    module.exports = {
        ...
        "test: regular brackets insertion": function() {
            ...
            testInsertion(new Range(2, 0, 2, 0), "(", "()%");
            testInsertion(new Range(2, 1, 2, 1), "[", "([])%");
            testInsertion(new Range(2, 2, 2, 2), "{", "([{}])%");
        },
