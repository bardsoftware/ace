...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "test: escaped $": function() {
            ...
            setupSession("\\ref");
            testInsertion(new Range(0, 1, 0, 1), "{", "\\{ref", 0, new Range(0, 2, 0, 2));
            setupSession("\\begin");
            testInsertion(new Range(0, 1, 0, 1), "{", "\\{begin", 0, new Range(0, 2, 0, 2));
            setupSession("$\\sum$");
            testInsertion(new Range(0, 2, 0, 2), "{", "$\\{sum$", 0, new Range(0, 3, 0, 3));
        },
