...
(function() {
  define(function(require, exports, module) {
    ...
    findSurroundingBrackets = function(editor) {
      var allBrackets, expectedRightBracket, infoHighlight, key, leftCandidate, leftNearest, positionLeftwards, positionRightwards, result, rightBracket, rightCandidate, rightNearest, session;
      session = editor.getSession();
      ...
      return result;
      return infoHighlight = function(editor, posLeft, posRight) {
        var content, options;
        session = editor.getSession();
        if (posLeft && posRight) {
