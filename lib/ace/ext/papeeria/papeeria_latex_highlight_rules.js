  ...
  define(function(require, exports, module) {
    ...
    PapeeriaLatexHighlightRules = function() {
      ...
      beginRule = function(text, pushedState) {
        return {
          token: ["storage.type", LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:begin))({)(" + text + ")(})",
      ...
      SimpleCommandState = (function() {
        ...
        SimpleCommandState.prototype.generateRules = function(openingRules, instateRules) {
          var closing, opening;
          opening = {
            token: ["storage.type", LPAREN_TOKENTYPE + "." + this.stateName],
      ...
      genericEnvironmentRule = {
        token: ["storage.type", LPAREN_TOKENTYPE + "." + ENVIRONMENT_TOKENTYPE, "variable.parameter." + ENVIRONMENT_TOKENTYPE, RPAREN_TOKENTYPE],
        regex: "(\\\\(?:begin|end))({)(\\w*)(})"
      };
      citationsRules = [];
      this.$rules = {};
      ...
      citationsRules = citationsRules.concat([
        {
          token: ["storage.type", LPAREN_TOKENTYPE + ".ref", "variable.parameter.ref", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:ref))({)(\\w*)(})"
        }, {
          token: ["keyword", LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:v?ref|cite(?:[^{]*)))(?:({)([^}]*)(}))?"
        }
      ]);
      this.$rules[START_STATE] = [].concat(equationStartRules, listStartRules, citationsRules, [
        {
          token: ["keyword", LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE, LPAREN_TOKENTYPE, "storage.type", RPAREN_TOKENTYPE],
