  ...
  define(function(require, exports, module) {
    ...
    PapeeriaLatexHighlightRules = function() {
      ...
      genericEnvironmentRule = {
        token: ["storage.type", ENVIRONMENT_TOKENTYPE + "." + FULL_LPAREN_TOKENTYPES, "variable.parameter." + ENVIRONMENT_TOKENTYPE, FULL_RPAREN_TOKENTYPES],
        regex: "(\\\\(?:begin|end))({)(\\w*)(})"
      };
      citationsRules = [];
      this.$rules = {};
      ...
      citationsRules = citationsRules.concat([
        {
          token: ["storage.type", "ref." + FULL_LPAREN_TOKENTYPES, "variable.parameter.ref", FULL_RPAREN_TOKENTYPES],
          regex: "(\\\\(?:ref))({)(\\w*)(})"
        }, {
