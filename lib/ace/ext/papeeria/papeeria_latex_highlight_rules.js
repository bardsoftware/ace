  ...
  define(function(require, exports, module) {
    ...
    PapeeriaLatexHighlightRules = function() {
        ...
        return [
          {
            ...
            token: "paren.lparen" + addToken,
            regex: "[[({]"
          }, {
            token: "paren.rparen" + addToken,
            regex: "[\\])}]"
          }, {
      ...
      beginRule = function(text, pushedState) {
        return {
          token: ["storage.type", "paren.lparen", "variable.parameter", "paren.rparen"],
          regex: "(\\\\(?:begin))({)(" + text + ")(})",
      ...
      SimpleCommandState = (function() {
        ...
        SimpleCommandState.prototype.generateRules = function(openingRules, instateRules) {
          var closing, opening;
          opening = {
            token: ["storage.type", "paren.lparen." + this.stateName],
      ...
      genericEnvironmentRule = {
        token: ["storage.type", "paren.lparen.environment", "variable.parameter.environment", "paren.rparen"],
        regex: "(\\\\(?:begin|end))({)(\\w*)(})"
      };
      citationsRules = [];
      this.$rules = {};
      ...
      citationsRules = citationsRules.concat([
        {
          token: ["storage.type", "paren.lparen.ref", "variable.parameter.ref", "paren.rparen"],
          regex: "(\\\\(?:ref))({)(\\w*)(})"
        }, {
          token: ["keyword", "paren.lparen", "variable.parameter", "paren.rparen"],
          regex: "(\\\\(?:v?ref|cite(?:[^{]*)))(?:({)([^}]*)(}))?"
        }
      ]);
      this.$rules[START_STATE] = [].concat(equationStartRules, listStartRules, citationsRules, [
        {
          token: ["keyword", "paren.lparen", "variable.parameter", "paren.rparen", "paren.lparen", "storage.type", "paren.rparen"],
