    ...
    PapeeriaLatexHighlightRules = function() {
      ...
      * @return {function} function, which correctly puts new type(pushedState) on stack
      ...
      this.$rules = {
        ...
        'equation': [beginRule(equationType, equationState), beginRule(listType, listState), endRule(equationType), endRule(listType)],
        'list': [beginRule(listType, listState), beginRule(equationType, equationState), endRule(equationType), endRule(listType)]
      };
