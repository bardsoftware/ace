...
(function() {
  ...
  define(function(require, exports, module) {
    "use strict";
    var COMMENT_TOKENTYPE, ENVIRONMENT_TOKENTYPE, EQUATION_TOKENTYPE, ERROR_TOKENTYPE, ESCAPE_TOKENTYPE, KEYWORD_TOKENTYPE, LIST_ENUMERATE_REGEX, LIST_ENUMERATE_STATE, LIST_ITEMIZE_REGEX, LIST_ITEMIZE_STATE, LIST_TOKENTYPE, LPAREN_TOKENTYPE, MATH_ENVIRONMENT_DISPLAYED_NUMBERED_REGEX, MATH_ENVIRONMENT_DISPLAYED_NUMBERED_STATE, MATH_ENVIRONMENT_DISPLAYED_REGEX, MATH_ENVIRONMENT_DISPLAYED_STATE, MATH_LATEX_DISPLAYED_CLOSING_REGEX, MATH_LATEX_DISPLAYED_OPENING_REGEX, MATH_LATEX_DISPLAYED_STATE, MATH_LATEX_INLINE_CLOSING_REGEX, MATH_LATEX_INLINE_OPENING_REGEX, MATH_LATEX_INLINE_STATE, MATH_TEX_DISPLAYED_CLOSING_REGEX, MATH_TEX_DISPLAYED_OPENING_REGEX, MATH_TEX_DISPLAYED_STATE, MATH_TEX_INLINE_CLOSING_REGEX, MATH_TEX_INLINE_OPENING_REGEX, MATH_TEX_INLINE_STATE, PapeeriaLatexHighlightRules, RPAREN_TOKENTYPE, SPECIFIC_TOKEN_FOR_STATE, START_STATE, STORAGE_TOKENTYPE, TextHighlightRules, oop;
    ...
    PapeeriaLatexHighlightRules = function() {
       ...
       */
      var SimpleCommandState, basicRules, beginRule, citationsInstateRules, citationsRules, citeCommandState, envEndRule, equationStartRules, genericEnvironmentRule, listStartRules, mathEndRules, mathEnvEndRules, mathStartRule, popState, pushState, state;
      ...
      beginRule = function(text, pushedState) {
        return {
          token: [STORAGE_TOKENTYPE + ".type", LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:begin))({)(" + text + ")(})",
      ...
      genericEnvironmentRule = {
        token: [STORAGE_TOKENTYPE + ".type", LPAREN_TOKENTYPE + "." + ENVIRONMENT_TOKENTYPE, "variable.parameter." + ENVIRONMENT_TOKENTYPE, RPAREN_TOKENTYPE],
        regex: "(\\\\(?:begin|end))({)(\\w*)(})"
      };
      citationsRules = [];
      this.$rules = {};
      ...
      citationsRules = citationsRules.concat([
        {
          token: [STORAGE_TOKENTYPE + ".type", LPAREN_TOKENTYPE + ".ref", "variable.parameter.ref", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:ref))({)(\\w*)(})"
        }, {
          token: ["" + KEYWORD_TOKENTYPE, LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE],
          regex: "(\\\\(?:v?ref|cite(?:[^{]*)))(?:({)([^}]*)(}))?"
        }
      ]);
      this.$rules[START_STATE] = [].concat(equationStartRules, listStartRules, citationsRules, [
        {
          token: ["" + KEYWORD_TOKENTYPE, LPAREN_TOKENTYPE, "variable.parameter", RPAREN_TOKENTYPE, LPAREN_TOKENTYPE, STORAGE_TOKENTYPE + ".type", RPAREN_TOKENTYPE],
      ...
      this.$rules[MATH_ENVIRONMENT_DISPLAYED_NUMBERED_STATE] = mathEnvEndRules(MATH_ENVIRONMENT_DISPLAYED_NUMBERED_REGEX);
      this.$rules[MATH_ENVIRONMENT_DISPLAYED_STATE] = mathEnvEndRules(MATH_ENVIRONMENT_DISPLAYED_REGEX);
