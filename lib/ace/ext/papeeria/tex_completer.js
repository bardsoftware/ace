  ...
  define(function(require, exports, module) {
    ...
    ReferenceGetter = (function() {
      function ReferenceGetter() {
        this.getReference = bind(this.getReference, this);
      ...
      ReferenceGetter.prototype.processData = function(data) {
        return this.cache = data.map(function(elem) {
          return {
            name: elem.caption,
            value: elem.caption,
      ...
      ReferenceGetter.prototype.getReference = function(url) {
        if (url !== this.cashedURL) {
          this.cachedURL = url;
          $.getJSON(url).done(this.processData);
        }
        return this.cache;
      };
    ...
    TexCompleter = (function() {
      ...
      TexCompleter.prototype.getCompletions = function(editor, session, pos, prefix, callback) {
        ...
        if (istype(token, "ref")) {
          return callback(null, this.refGetter.getReference("example.json"));
