...
(function() {
  ...
  define(function(require, exports, module) {
    var BASIC_SNIPPETS, EQUATION_ENVIRONMENTS, EQUATION_ENV_SNIPPETS, EQUATION_SNIPPETS, EQUATION_STATE, HashHandler, LIST_END_ENVIRONMENT, LIST_ENVIRONMENTS, LIST_KEYWORDS, LIST_SNIPPET, LIST_STATE, LatexParsingContext, PapeeriaLatexHighlightRules, REFERENCE_SNIPPET, ReferenceGetter, TexCompleter, env, init;
      ...
      TexCompleter.prototype.getCompletions = function(editor, session, pos, prefix, callback) {
        ...
        if (LatexParsingContext.isType(token, "ref") && (this.referencesUrl != null)) {
          ...
          switch (context) {
            ...
            case LIST_STATE:
              return callback(null, LIST_KEYWORDS.concat(EQUATION_ENV_SNIPPETS, LIST_SNIPPET, LIST_END_ENVIRONMENT));
            case EQUATION_STATE:
