...
(function() {
  define(function(require, exports, module) {
    var EQUATION_STATE, LIST_STATE, PapeeriaLatexHighlightRules, ReferenceGetter, TexCompleter, basicSnippets, env, equationEnvironments, equationKeywords, equationKeywords_, equationSnippets, formulasSnippets, istype, listEnvironments, listKeywords, listKeywords_, listSnippets;
    ...
    return exports = TexCompleter = (function() {
      ...
      TexCompleter.prototype.getCompletions = function(editor, session, pos, prefix, callback) {
        ...
        if (istype(token, "ref")) {
          return callback(null, this.r.getReference("ace.json", function(data, r) {
