...
(function() {
  ...
  define(function(require, exports, module) {
    var BASIC_SNIPPETS, CITATION_SNIPPET, CompletionsCache, ENVIRONMENT_LABELS, ENVIRONMENT_TOKENTYPE, EQUATION_ENVIRONMENTS, EQUATION_ENV_SNIPPETS, EQUATION_SNIPPETS, EQUATION_TOKENTYPE, FIGURE_TOKENTYPE, HashHandler, LIST_END_ENVIRONMENT, LIST_ENVIRONMENTS, LIST_KEYWORDS, LIST_SNIPPET, LIST_TOKENTYPE, LatexParsingContext, OTHER_ENVIRONMENTS, PapeeriaLatexHighlightRules, REFERENCE_SNIPPET, TABLE_TOKENTYPE, TexCompleter, compare, env, getJsonFromUrl, processCitationJson, processReferenceJson, showPopupIfTokenIsOneOfTypes;
                ...
                if (_this.filesUrl != null) {
                  return _this.filesCache.getReferences(_this.filesUrl, function(err, files) {
                    return callback(null, cites.map(function(cite) {
                      var ref;
                      if ((ref = cite.path, indexOf.call(files, ref) >= 0)) {
                        return cite;
                      } else {
                        return {
                          name: cite.name,
        ...
        if ((prefix.length >= 2 && prefix[0] === "\\") || (prefix.length >= 3)) {
          switch (context) {
            ...
            case LIST_TOKENTYPE:
              ...
              break;
            case EQUATION_TOKENTYPE:
              callback(null, EQUATION_SNIPPETS);
              break;
            case ENVIRONMENT_TOKENTYPE:
