...
(function() {
  ...
  define(function(require, exports, module) {
    var BASIC_SNIPPETS, CITATION_SNIPPET, EQUATION_ENVIRONMENTS, EQUATION_ENV_SNIPPETS, EQUATION_SNIPPETS, EQUATION_STATE, HashHandler, LIST_END_ENVIRONMENT, LIST_ENVIRONMENTS, LIST_KEYWORDS, LIST_SNIPPET, LIST_STATE, LatexParsingContext, PapeeriaLatexHighlightRules, PropertyGetter, REFERENCE_SNIPPET, TexCompleter, compare, env, init, processCitationJson, processReferenceJson, showPopupIfTokenIsOneOfTypes;
    ...
    PropertyGetter = (function() {
      function PropertyGetter(processJson) {
      ...
      PropertyGetter.prototype.processData = function(data) {
        var ref;
        return this.cache = (ref = data.Labels) != null ? ref.map(this.processJson) : void 0;
      };

      PropertyGetter.prototype.getReferences = function(url, callback) {
    ...
    TexCompleter = (function() {
      function TexCompleter() {
        ...
        this.refGetter = new PropertyGetter(processReferenceJson);
        this.citeGetter = new PropertyGetter(processCitationJson);
      }
      ...
      TexCompleter.prototype.getCompletions = function(editor, session, pos, prefix, callback) {
        ...
        if (LatexParsingContext.isType(token, "ref")) {
          ...
          if (this.citationsUrl != null) {
            return this.citeGetter.getReferences(this.citationsUrl, callback);
          }
        } else {
          switch (context) {
            case "start":
