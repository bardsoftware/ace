...
(function() {
  ...
  define(function(require, exports, module) {
    ...
    processFilesJson = (function(_this) {
      return function(json) {
        return json;
      };
    })(this);
    ...
    * @ (list of strings) -- allowedTypes
    ...
    TexCompleter = (function() {
      function TexCompleter() {
        ...
        this.filesCache = new CompletionsCache(getJsonFromUrl, processFilesJson);
        this.enabled = true;
      }
                  ...
                  return _this.filesCache.getReferences(_this.filesUrl, function(err, files) {
                    cites.map(function(cite) {
                      ...
                      if (!(ref = cite.meta, indexOf.call(files, ref) >= 0)) {
                        cite.meta_score = 9;
                        return cite.action = function(editor) {
