...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "test: no mismatch, cursor between brackets": function() {
            ...
            assert.range(getMatchRangeHighlightingText(session), 0, 1, 0, 11);
        },
        ...
        "test: no mismatch, cursor cursor next position before right bracket": function() {
            ...
            assert.position(getMatchRangeHighlightingText(session), 0, 1, 0, 11);
        },
        ...
        "test: no mismatch, multiline, cursor between brackets": function() {
            ...
            assert.position(getMatchRangeHighlightingText(session), 0, 1, 1, 13);
        }
