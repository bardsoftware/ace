...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "test: no mismatch, cursor between brackets": function() {
            ...
            assert.range(highlighter.findSurroundingBrackets(session, editor.getCursorPosition()), 0, 0, 0, 10);
        },
        ...
        "test: no mismatch, cursor next position after left bracket": function() {
            ...
            range = highlighter.findSurroundingBrackets(session, editor.getCursorPosition());
        ...
        "test: no mismatch, multiline, cursor between brackets": function() {
            ...
            assert.range(highlighter.findSurroundingBrackets(session, editor.getCursorPosition()), 0, 0, 1, 12);
        },
