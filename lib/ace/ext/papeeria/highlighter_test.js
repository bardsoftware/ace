...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        "Nested blocks: cursor above the inner {}": function() {
        ...
        "Nested blocks: cursor below the inner {}": function() {
            var session = new EditSession(["{", "", "", "{", "    ", "}", "", "}"])
            var editor = new Editor(new MockRenderer(), session);
            session.setMode("./mode/papeeria_latex");
        ...
        "Nested blocks: cursor exactly where inner {} starts": function() {
            var session = new EditSession(["{", "", "", "{", "    ", "}", "", "}"])
            var editor = new Editor(new MockRenderer(), session);
            session.setMode("./mode/papeeria_latex");
        ...
        "Nested blocks: cursor exactly where inner {} ends": function() {
            var session = new EditSession(["{", "", "", "{", "    ", "}", "", "}"])
            var editor = new Editor(new MockRenderer(), session);
            session.setMode("./mode/papeeria_latex");
        ...
        "Nested blocks and doubled closing bracket": function() {
        ...
        "Comments: cursor inside commented ()": function() {
