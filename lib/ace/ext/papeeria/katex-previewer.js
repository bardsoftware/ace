  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.extractEquation = function(session, range) {
        var bracketString, closingBracketIndex, closingBracketPos, content, curIndex, end, endIndex, equationStrings, joinedLines, labelStartIndex, labelString, labels, openingBracketIndex, openingBracketPos, row, start, startIndex;
