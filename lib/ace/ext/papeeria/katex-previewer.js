...
(function() {
  ...
  define(function(require, exports, module) {
    var COMMENT_TOKENTYPE, ConstrainedTokenIterator, ContextHandler, EQUATION_CONTEXT, ERROR_CONTEXT, ERROR_TOKENTYPE, EquationRangeHandler, LABEL_TOKENTYPE, PARAMETER_TOKENTYPE, Range, SelectionHandler, equalTokens, getContext, getContexts, initKaTeX, isType, katex, myContextHandler, myKatexLoader, ref, ref1, reset, setupPreviewer, sh;
    ref = require("ace/ext/papeeria/latex_parsing_context"), EQUATION_CONTEXT = ref.EQUATION_CONTEXT, ERROR_CONTEXT = ref.ERROR_CONTEXT, getContext = ref.getContext, getContexts = ref.getContexts;
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(session, row, column, start) {
        var correct, curColumn, curContexts, curIndex, curRow, nextColumn, nextContexts, nextIndex, nextRow, reason, ref2, startRow, summand;
        summand = start ? -1 : 1;
        startRow = row;
        ...
        reason = null;
        while (true) {
          if (correct && curContexts.includes(ERROR_CONTEXT)) {
            correct = false;
            reason = EquationRangeHandler.WHITESPACE_LINE_ERROR_CODE;
          }
          if (correct && session.getLine(curRow).length === 0) {
            correct = false;
          ...
          if (!nextContexts.includes(EQUATION_CONTEXT)) {
            return {
              correct: correct,
              reason: reason,
              row: curRow,
