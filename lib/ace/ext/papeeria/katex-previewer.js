    ...
    exports.setupPreviewer = function(editor, popoverHandler) {
      ...
      ch = ContextHandler = {
        ...
        getWholeEquation: function(range) {
          var argumentRange, bracketPosition, curLabelParameter, curLabelTokens, curLine, labelParameters, labelSequenceIndex, noPush, session, token, tokenIterator, tokenPosition, tokenValues;
          tokenValues = [];
