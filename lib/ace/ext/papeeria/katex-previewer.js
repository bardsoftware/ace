  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.prototype.getCurrentFormula = function() {
        var e, equationString, labelParameters, ref, start, title, tokenIterator;
        try {
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(tokenIterator, start) {
        var boundaryCorrect, curTokenColumn, curTokenLength, curTokenRow, currentRow, currentToken, moveFromBoundary, moveToBoundary, prevRow, reasonCode, ref;
