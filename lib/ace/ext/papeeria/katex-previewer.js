  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.prototype.updateRange = function() {
        ...
        return ref1 = this.equationRangeHandler.getEquationRange(cursorRow, cursorColumn), this.curOuterRange = ref1[0], this.curInnerRange = ref1[1], ref1;
      };
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getEquationRange = function(row, column) {
        var end, innerEnd, innerRange, innerStart, outerEnd, outerRange, outerStart, start, tokenIterator;
        ...
        outerEnd = end[0], innerEnd = end[1];
        outerStart = start[0], innerStart = start[1];
