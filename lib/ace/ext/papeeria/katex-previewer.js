  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.prototype.getCurrentFormula = function() {
        ...
        try {
          if (this.curStartString !== this.curEndString) {
            return ["Error!", "Starting and ending sequences don't match: " + (JSON.stringify(this.curStartString)) + " and " + (JSON.stringify(this.curEndString))];
          }
      ...
      ContextHandler.prototype.updateRange = function() {
        ...
        return ref1 = this.equationRangeHandler.getEquationRange(cursorRow, cursorColumn), this.curOuterRange = ref1[0], this.curInnerRange = ref1[1], this.curStartString = ref1[2], this.curEndString = ref1[3], ref1;
      };
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(tokenIterator, start) {
        var boundarySequence, boundarySequences, curEquationInnerBoundary, curEquationOuterBoundary, curSequence, curSequenceIndex, curToken, curTokenPosition, j, k, l, len, len1, len2, moveFromBoundary, moveToBoundary, ref, token;
        ...
        while (true) {
          ...
          if (curSequence === null) {
            for (l = 0, len2 = boundarySequences.length; l < len2; l++) {
      ...
      EquationRangeHandler.prototype.getEquationRange = function(row, column) {
        var end, endString, innerEnd, innerRange, innerStart, outerEnd, outerRange, outerStart, start, startString, tokenIterator;
        ...
        endString = end[0], outerEnd = end[1], innerEnd = end[2];
        startString = start[0], outerStart = start[1], innerStart = start[2];
