...
(function() {
  ...
  define(function(require, exports, module) {
    var ContextHandler, EQUATION_CONTEXT, ERROR_TOKENTYPE, EquationRangeHandler, Range, SelectionHandler, equalTokens, getContext, initKaTeX, isType, katex, myContextHandler, myKatexLoader, ref, reset, setupPreviewer, sh;
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.extractEquation = function(session, range) {
        var bracketString, closingBracketIndex, closingBracketPos, content, curIndex, end, endIndex, equationStrings, joinedLines, labelRe, labelStartIndex, labels, match, matchedString, openingBracketIndex, openingBracketPos, row, start, startIndex;
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(session, row, column, start) {
        var correct, curColumn, curIndex, curRow, nextColumn, nextIndex, nextRow, reason, ref1, summand, token;
        summand = start ? -1 : 1;
