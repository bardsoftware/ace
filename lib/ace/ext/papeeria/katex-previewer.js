...
(function() {
  ...
  define(function(require, exports, module) {
    var ConstrainedTokenIterator, ContextHandler, EQUATION_CONTEXT, ERROR_TOKENTYPE, EquationRangeHandler, Range, SelectionHandler, TokenIterator, equalTokens, findSurroundingBrackets, getContext, initKaTeX, isType, katex, myContextHandler, myKatexLoader, ref, reset, setupPreviewer, sh;
    ref = require("ace/ext/papeeria/latex_parsing_context"), EQUATION_CONTEXT = ref.EQUATION_CONTEXT, getContext = ref.getContext;
    ERROR_TOKENTYPE = require("ace/ext/papeeria/papeeria_latex_highlight_rules").ERROR_TOKENTYPE;
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.extractEquation = function(session, range) {
        ...
        joinedLines = ((function() {
          ...
          results = [];
          for (row = j = ref1 = start.row, ref2 = end.row; ref1 <= ref2 ? j <= ref2 : j >= ref2; row = ref1 <= ref2 ? ++j : --j) {
      ...
      ContextHandler.prototype.getCurrentFormula = function() {
        var e, equation, labels, ref1, title;
        try {
          ...
          ref1 = ContextHandler.extractEquation(this.editor.getSession(), this.currentRange), labels = ref1.labels, equation = ref1.equation;
      ...
      ContextHandler.prototype.initPopover = function() {
        var popoverPosition, ref1, rendered, title;
        popoverPosition = this.getPopoverPosition(this.getEquationEndRow());
        ref1 = this.getCurrentFormula(), title = ref1.title, rendered = ref1.content;
      ...
      ContextHandler.prototype.updateRange = function() {
        var cursorPos, reason, reasons, ref1;
        cursorPos = this.editor.getCursorPosition();
        ref1 = this.equationRangeHandler.getEquationRange(cursorPos.row, cursorPos.column), this.rangeCorrect = ref1.correct, reasons = ref1.reasons, this.currentRange = ref1.range;
    ...
    ConstrainedTokenIterator = (function() {
      function ConstrainedTokenIterator(session1, range1, row, column) {
        var curToken, ref1, tokenColumn, tokenRange, tokenRow;
        ...
        ref1 = this.tokenIterator.getCurrentTokenPosition(), tokenRow = ref1.row, tokenColumn = ref1.column;
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(session, row, column, start) {
        var correct, curColumn, curIndex, curRow, nextColumn, nextIndex, nextRow, reason, ref1, ref2, summand, token;
        summand = start ? -1 : 1;
        curIndex = session.doc.positionToIndex({
          row: row,
          column: column
        });
        ref1 = session.doc.indexToPosition(curIndex), curRow = ref1.row, curColumn = ref1.column;
        while (true) {
          nextIndex = curIndex + summand;
          ref2 = session.doc.indexToPosition(nextIndex), nextRow = ref2.row, nextColumn = ref2.column;
