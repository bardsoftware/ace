  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.prototype.updateRange = function() {
        ...
        this.currentRange = this.equationRangeHandler.getEquationRange(cursorRow, cursorColumn);
        this.rangeExists = true;
        return this.rangeCorrect = this.currentRange != null;
      };
      ...
      ContextHandler.prototype.handleCurrentContext = function() {
        return setTimeout(((function(_this) {
          return function() {
            ...
            if (!_this.rangeExists && currentContext === "equation") {
              _this.updateRange();
            }
            if (_this.rangeExists && currentContext !== "equation") {
              _this.destroyRange();
            }
            if (_this.rangeExists && _this.rangeCorrect && !_this.contextPreviewExists) {
              _this.createContextPreview();
            }
            if (!(_this.rangeExists && _this.rangeCorrect) && _this.contextPreviewExists) {
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(tokenIterator, start) {
        var boundarySequences, curTokenColumn, curTokenLength, curTokenRow, currentRow, currentToken, moveFromBoundary, moveToBoundary, prevRow, ref;
      ...
      EquationRangeHandler.prototype.getEquationRange = function(row, column) {
        var end, endColumn, endRow, endToken, start, startColumn, startRow, startToken, tokenIterator;
        ...
        startToken = start.token, startRow = start.row, startColumn = start.column;
        endToken = end.token, endRow = end.row, endColumn = end.column;
