  ...
  define(function(require, exports, module) {
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.handleIdenticals = function(tokenIterator, start) {
        var begins, boundaries, boundarySequence, curColumn, curRow, ends, i, k, l, len, len1, m, matchCount, matchedBoundary, moveFromBoundary, moveToBoundary, n, ref, ref1, ref2, ref3, results, token;
        ...
        results = [];
        for (i = k = 0, ref = begins.length - 1; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
          if (EquationRangeHandler.HAS_IDENTICAL_BOUNDARIES[i]) {
            if (EquationRangeHandler.equalTokens(tokenIterator.getCurrentToken(), begins[i][0])) {
              ...
              if (LatexParsingContext.getContext(this.editor.getSession(), curRow, curColumn) === "equation") {
                ...
                for (l = 0, len = boundaries.length; l < len; l++) {
                  boundarySequence = boundaries[l];
                  matchCount = 0;
                  ...
                  if (matchCount > 0) {
                    for (i = n = 1, ref3 = matchCount; 1 <= ref3 ? n <= ref3 : n >= ref3; i = 1 <= ref3 ? ++n : --n) {
                      moveFromBoundary();
                    }
                  }
      ...
      EquationRangeHandler.prototype.getBoundary = function(tokenIterator, start) {
        var boundarySequence, boundarySequences, curEquationBoundary, curSequence, curSequenceIndex, curToken, curTokenPosition, i, k, l, len, len1, m, moveFromBoundary, moveToBoundary, ref, ref1, token;
        moveToBoundary = start ? ((function(_this) {
          return function() {
            return tokenIterator.stepBackward();
          };
        ...
        if (tokenIterator.getCurrentToken() == null) {
          ...
          for (i = k = 0, ref = boundarySequences.length - 1; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
            if (!EquationRangeHandler.HAS_IDENTICAL_BOUNDARIES[i]) {
