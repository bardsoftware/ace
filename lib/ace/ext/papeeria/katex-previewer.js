    ...
    exports.setupPreviewer = function(editor, popoverHandler) {
      ...
      ch = ContextHandler = {
        ...
        getWholeEquation: function(tokenIterator) {
          var argumentRange, bracketPosition, curLabelParameter, curLabelTokens, curLine, labelParameters, labelSequenceIndex, noPush, range, session, token, tokenPosition, tokenValues;
          tokenValues = [];
