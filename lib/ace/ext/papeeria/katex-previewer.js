...
(function() {
  ...
  define(function(require, exports, module) {
    var ContextHandler, EQUATION_CONTEXT, ERROR_TOKENTYPE, EquationRangeHandler, Range, SelectionHandler, equalTokens, getContext, initKaTeX, isType, katex, myContextHandler, myKatexLoader, ref, ref1, reset, setupPreviewer, sh;
    ref = require("ace/ext/papeeria/latex_parsing_context"), EQUATION_CONTEXT = ref.EQUATION_CONTEXT, getContext = ref.getContext;
    ref1 = require("ace/ext/papeeria/papeeria_latex_highlight_rules"), ERROR_TOKENTYPE = ref1.ERROR_TOKENTYPE, isType = ref1.isType;
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.extractEquation = function(session, range) {
        ...
        joinedLines = ((function() {
          ...
          results = [];
          for (row = j = ref2 = start.row, ref3 = end.row; ref2 <= ref3 ? j <= ref3 : j >= ref3; row = ref2 <= ref3 ? ++j : --j) {
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(session, row, column, start) {
        var correct, curColumn, curIndex, curRow, nextColumn, nextIndex, nextRow, reason, ref2, summand, token;
        summand = start ? -1 : 1;
