  ...
  define(function(require, exports, module) {
    ...
    ContextHandler = (function() {
      ...
      ContextHandler.prototype.getCurrentFormula = function() {
        ...
        try {
          ref = this.currentRange.start, startRow = ref.row, startColumn = ref.column;
          tokenIterator = new ConstrainedTokenIterator(this.editor.getSession(), this.currentRange, startRow, startColumn);
          tokenIterator.stepForward();
      ...
      ContextHandler.prototype.updateRange = function() {
        ...
        ref1 = this.equationRangeHandler.getEquationRange(cursorRow, cursorColumn), this.rangeCorrect = ref1.correct, this.currentRange = ref1.range;
        return this.rangeExists = true;
      };

      ContextHandler.prototype.destroyRange = function() {
        this.currentRange = null;
        return this.rangeExists = this.rangeCorrect = false;
      };
      ...
      ContextHandler.prototype.updateCallback = function() {
        ...
        if (this.lastChangeTime != null) {
          ...
          if (this.rangeExists && this.rangeCorrect) {
            if (this.contextPreviewExists) {
      ...
      ContextHandler.prototype.handleCurrentContext = function() {
        ...
        ref = this.editor.getCursorPosition(), cursorRow = ref.row, cursorColumn = ref.column;
        currentContext = LatexParsingContext.getContext(this.editor.getSession(), cursorRow, cursorColumn);
        if (this.rangeExists && !this.currentRange.contains(cursorRow, cursorColumn)) {
          this.destroyRange();
          this.disableUpdates();
        }
        if (!(this.rangeExists && this.rangeCorrect) && this.contextPreviewExists) {
          this.destroyContextPreview();
        }
        if (!this.rangeExists && currentContext === "equation") {
          this.updateRange();
          this.enableUpdates();
        }
        if (this.rangeExists && this.rangeCorrect && !this.contextPreviewExists) {
    ...
    EquationRangeHandler = (function() {
      ...
      EquationRangeHandler.prototype.getBoundary = function(tokenIterator, start) {
        var boundaryCorrect, boundarySequences, curTokenColumn, curTokenLength, curTokenRow, currentRow, currentToken, moveFromBoundary, moveToBoundary, prevRow, ref;
      ...
      EquationRangeHandler.prototype.getEquationRange = function(row, column) {
        var end, endColumn, endCorrect, endRow, start, startColumn, startCorrect, startRow, tokenIterator;
        ...
        startCorrect = start.correct, startRow = start.row, startColumn = start.column;
        endCorrect = end.correct, endRow = end.row, endColumn = end.column;
        return {
