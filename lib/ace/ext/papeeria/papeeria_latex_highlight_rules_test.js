...
define(function(require, exports, module) {
    ...
    var EQUATION_REGULAR_STATE = RulesModule.EQUATION_REGULAR_STATE;
    var EQUATION_ASTERISK_STATE = RulesModule.EQUATION_ASTERISK_STATE;
    var MATH_INLINE_STATE = RulesModule.MATH_INLINE_STATE;
    var MATH_MULTILINE_STATE = RulesModule.MATH_MULTILINE_STATE;
    var MATH_ALTERNATIVE_STATE = RulesModule.MATH_ALTERNATIVE_STATE;
    ...
    module.exports = {
        ...
        "test: $: basic and mismatching ends": function() {
            ...
            // the first token is `$`
            for (var i = 1; i < tokens.length; i++) {
                assert(isType(tokens[i], EQUATION_TOKEN_TYPE), "" + i);
            }
        },
        ...
        "test: nested equation starts": function() {
            ...
            var equationStates = [
                EQUATION_REGULAR_STATE,
                EQUATION_ASTERISK_STATE,
                MATH_ALTERNATIVE_STATE
            ]
