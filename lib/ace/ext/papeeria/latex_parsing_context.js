...
(function() {
  ...
  define(function(require, exports, module) {
    var COMMENT_CONTEXT, COMMENT_TOKENTYPE, CONTEXTS_FOR_TOKENTYPES, CONTEXT_TOKENTYPES, ENVIRONMENT_CONTEXT, ENVIRONMENT_TOKENTYPE, EQUATION_CONTEXT, EQUATION_TOKENTYPE, ERROR_CONTEXT, ERROR_TOKENTYPE, LIST_CONTEXT, LIST_TOKENTYPE, SPECIFIC_TOKEN_FOR_STATE, START_CONTEXT, getContext, getContexts, isType, ref;
    ref = require("ace/ext/papeeria/papeeria_latex_highlight_rules"), COMMENT_TOKENTYPE = ref.COMMENT_TOKENTYPE, LIST_TOKENTYPE = ref.LIST_TOKENTYPE, EQUATION_TOKENTYPE = ref.EQUATION_TOKENTYPE, ENVIRONMENT_TOKENTYPE = ref.ENVIRONMENT_TOKENTYPE, ERROR_TOKENTYPE = ref.ERROR_TOKENTYPE, SPECIFIC_TOKEN_FOR_STATE = ref.SPECIFIC_TOKEN_FOR_STATE, isType = ref.isType;
    ...
    CONTEXT_TOKENTYPES = [EQUATION_TOKENTYPE, ERROR_TOKENTYPE, COMMENT_TOKENTYPE, ENVIRONMENT_TOKENTYPE, LIST_TOKENTYPE];
    ...
    getContexts = function(session, row, column) {
      var contextTokentype, contexts, i, len, nextColumn, nextRow, nextToken, prevState, ref1, token, tokentype;
      contexts = [];
      if (column > 0) {
        ...
        if (row > 0) {
          ...
          contexts.push(tokentype != null ? CONTEXTS_FOR_TOKENTYPES[tokentype] : START_CONTEXT);
        }
      }
