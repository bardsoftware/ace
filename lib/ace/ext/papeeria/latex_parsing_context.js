...
(function() {
  ...
  define(function(require, exports, module) {
    var COMMENT_TOKENTYPE, ENVIRONMENT_TOKENTYPE, EQUATION_TOKENTYPE, ESCAPE_TOKENTYPE, FIGURE_TOKENTYPE, LIST_TOKENTYPE, LPAREN_TOKENTYPE, PapeeriaLatexHighlightRules, RPAREN_TOKENTYPE, SPECIFIC_TOKEN_FOR_STATE, TABLE_TOKENTYPE, TOKENTYPES, getContext, getContextFromRow, isType;
    ...
    TOKENTYPES = [COMMENT_TOKENTYPE, ESCAPE_TOKENTYPE, LIST_TOKENTYPE, EQUATION_TOKENTYPE, ENVIRONMENT_TOKENTYPE, TABLE_TOKENTYPE, FIGURE_TOKENTYPE, LPAREN_TOKENTYPE, RPAREN_TOKENTYPE];
