...
(function() {
  ...
  define(function(require, exports, module) {
    var EQUATION_STATE, LIST_STATE, PapeeriaLatexHighlightRules, getContext, getContextFromRaw, isType;
    ...
    getContext = function(session, row, column) {
      ...
      if ((token != null) && isType(token, "math")) {
        ...
        return getContextFromRaw(session, row);
      }
    };
    getContextFromRaw = function(session, row) {
      var states;
