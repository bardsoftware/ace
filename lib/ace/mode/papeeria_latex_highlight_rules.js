...
(function() {
  define(function(require, exports, module) {
    ...
    PapeeriaLatexHighlightRules = function() {
      ...
      endRule = function(text, destination) {
        if (text == null) {
          text = '\\w*';
        }
        if (destination == null) {
      ...
      this.$rules = {
        'start': [beginRule('itemize|enumerate', 'list'), beginRule('equation|equation*', 'equation')],
        'equation': [beginRule('equation|equation*', 'equation'), endRule('equation|equation*'), beginRule('itemize|enumerate', 'list')],
        'list': [beginRule('itemize|enumerate', 'list'), beginRule('equation|equation*', 'equation'), endRule("itemize|enumerate")]
      };
